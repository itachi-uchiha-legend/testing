...
|Disable Event Splitting|If enabled, the connector will not split original events into multiple. If this parameter is enabled, you would see a matching count of events between Chronicle SIEM and SOAR.|False|Boolean|true|
